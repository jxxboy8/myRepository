...
void WorleyNoise::noise1D(float at, long maxOrder,
...
void WorleyNoise::noise2D(float at[2], long maxOrder,
...
void WorleyNoise::noise3D(float at[3], long maxOrder,
...
void addSamples(long xi, long maxOrder, float at, float *F, float(*delta), unsigned long *ID)
{
    float dx, fx, d2;
